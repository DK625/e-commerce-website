...
class SignUpModel(BaseModel):
    ...
    def create_user(self, email, password, username, name, role_id, phone_number, address):
        ...
        user = User(email=email, password=hashed_password, username=username, name=name, role_id=role_id, phone_number=phone_number, address=address)
...
class SignUpService:
    ...
    def handle_sign_up(self):
        ...
        existing_user = self._repo.check_exit_user(email, password)
