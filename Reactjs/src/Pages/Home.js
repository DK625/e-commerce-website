                        ...
                        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-0">
                            ...
                            <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                                <div class="navbar-nav mr-auto py-0">
                                    ...
                                    <a href="detail.html" class="nav-item nav-link">Products Detail</a>
                                    <div class="nav-item dropdown">
                                        <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Pages</a>
                                        <div class="dropdown-menu rounded-0 m-0">
                                            <a href="cart.html" class="dropdown-item">Shopping Cart</a>
                                            <a href="checkout.html" class="dropdown-item">Checkout</a>
                                            <a href="order_tracking.html" class="dropdown-item">Order Tracking</a>
                                ...
                                <div class="navbar-nav ml-auto py-0">
                                    <a href="login-form-v4/Login_v4/login.html" class="nav-item nav-link">Login</a>
                                    <a href="sign_up_form/colorlib-regform-8/index.html" class="nav-item nav-link">Register</a>
                                </div>
                            </div>
                        </nav>
